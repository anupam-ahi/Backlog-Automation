        ...
        if formset.is_valid():
            ...
            for form in formset:
                try:
                    ...
                    subject_data.update({f"{subject_code}": y})
                    # print(subject_data)
                except KeyError:
                    break
...
def student_information(request):
    ...
    return render(request, 'student_info.html', {'stud': student_dict, 'sub_info_dict': sub_info_dict, 'total_amount':total_amount})
